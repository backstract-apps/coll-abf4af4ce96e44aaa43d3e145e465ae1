...
app = FastAPI(title='Backstract Generated APIs - coll-abf4af4ce96e44aaa43d3e145e465ae1', debug=False,
              docs_url='/romantic-bell-148e833058be11f0a09d9e75d130a19465/docs',
              openapi_url='/romantic-bell-148e833058be11f0a09d9e75d130a19465/openapi.json')
...
app.include_router(
    router,
    prefix='/romantic-bell-148e833058be11f0a09d9e75d130a19465/api',
    tags=['APIs v1']
)
